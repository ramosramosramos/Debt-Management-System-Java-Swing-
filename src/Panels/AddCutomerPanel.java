...
public class AddCutomerPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(error_user_id, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 20, 290, 30));
    ...
    void addCustomer() {
        ...
        String expiration_date = expiration_date_field.getText().trim();

        if (user_id.isEmpty() && amount.isEmpty() && type_id.isEmpty() && expiration_date.isEmpty()) {
